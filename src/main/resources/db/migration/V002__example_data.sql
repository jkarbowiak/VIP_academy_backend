...
-- books
insert into book (id, genre, title, version, library_id) values (1, 'CRIME', 'Nie mów nikomu', 0, 1);
insert into book (id, genre, title, version, library_id) values (2, 'CRIME', 'Wszyscy mamy tajemnice', 0, 1);
insert into book (id, genre, title, version, library_id) values (3, 'IT', 'Clean Code', 0, 2);
insert into book (id, genre, title, version, library_id) values (4, 'IT', 'Sztuka programowania', 0, 2);
